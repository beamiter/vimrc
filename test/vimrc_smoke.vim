...
assert_equal(2, exists(':VimrcRemoteConnect'))
assert_equal(2, exists(':VimrcRemoteDisconnect'))
assert_equal(2, exists(':VimrcRemoteOpen'))
assert_equal(2, exists(':VimrcRemoteStatus'))
...
assert_equal('<Cmd>VimrcRemoteDisconnect<CR>', maparg('<Space>rd', 'n'))
assert_equal('<Cmd>call g:VimrcRemotePromptFind()<CR>', maparg('<Space>rf', 'n'))
assert_equal('<Cmd>VimrcRemoteGit status --short<CR>', maparg('<Space>rg', 'n'))
assert_equal('<Cmd>VimrcRemoteHealth<CR>', maparg('<Space>rh', 'n'))
assert_equal('<Cmd>VimrcRemoteStatus<CR>', maparg('<Space>rs', 'n'))
assert_equal('<Cmd>VimrcRemoteList<CR>', maparg('<Space>rt', 'n'))
