...
_G.packer_plugins = {
  ...
  ["nvcode-color-schemes.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvcode-color-schemes.vim",
  ...
  ["onedarker.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/onedarker.nvim",
  ...
  ["vim-grepper"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-grepper",
