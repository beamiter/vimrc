...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(monokai molokai doom-one doom-dracula material kaolin-dark github
       material-light kaolin-light dakrone doom-monokai-spectrum spacemacs-dark
       spacemacs-light)
